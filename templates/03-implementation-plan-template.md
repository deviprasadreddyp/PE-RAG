...
- **Files:** `sec_rag/ingest/parser.py`, tests.
...
- **Files:** `sec_rag/ingest/chunker.py`, `sec_rag/index/embedder.py`, `sec_rag/index/store.py`.
...
- **Files:** `sec_rag/retrieval/retriever.py`, `sec_rag/retrieval/context.py`.
...
- **Files:** `sec_rag/generation/prompt.py`, `sec_rag/generation/answer.py`, `prompts/CHANGELOG.md`.
...
- [ ] Prompt change (if any) logged in `prompts/CHANGELOG.md`.
